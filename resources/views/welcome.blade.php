...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-white-100 dark:bg-white-900 sm:items-center py-4 sm:pt-0">
            ...
            @endif
            <center>
        <h2><a>Halo! Terimakasih sudah mengikuti tutorial saya :D, di halaman ini kalian cukup ketik "/siswa" di url atas setelah "http://127.0.0.1:8000" Terimakasih dan Enjoy Your Work!</a></h2>
            </center>
    </body>
</html>
